...
public class P01 {
    ...
    /*
    Exploratory testing:sayfayi manuel olarak girip tanimaya calismaktir,cünkü bazi verileri soruda vermeyebilir,ancak
    bakarak gorebiliriz.buna denir
     */
    @Test
    public void test01() throws InterruptedException {
        ...
        List<String> worklist=new ArrayList<>(Arrays.asList("Kahvaltiyi hazirla","Bulasiklari yika",
                "Bebekle ilgilen","Cocugunun odevine yardim et","Selenyum calis","Uyu"));
