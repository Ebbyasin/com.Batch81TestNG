...
public class C03_SoftAssert extends TestBaseBeforeClassAfterClass {
    ...
    public void test01() {
        ...
        // Bir yorum:Hocam yani assertAll kadar Faile de olsa kod çalışıyor ve programı durdurmuyor, ve assertAll  a
        // kadar olan tum hataları bize yazdırıyor doğrumu anlamışım
    }
}
