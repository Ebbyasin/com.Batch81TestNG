...
public class P01 extends TestBaseBeforeMethodAfterMethod {
    ...
    public void test01() {
        ...
        //fill the firstname
        driver.findElement(By.xpath("//input[@name='firstname']")).sendKeys("Yasin");

        //fill the lastname
        driver.findElement(By.xpath("//input[@name='lastname']")).sendKeys("Mese");
        ...
        //fill the date
        driver.findElement(By.xpath("//input[@id='datepicker']")).sendKeys("15.07.1982");
      ...
      /*  WebElement dropdownContinent =driver.findElement(By.xpath("//select[@id='continents']"));
        ...
        select.selectByVisibleText("Antartice");
