...
public class P01 {
    ...
    public void test01() {
        ...
        /*
        Frameworkler buyudukce yeni classlar yeni test methdolari yeni webelementler olusturdukca icinden cikilmaz
        anlasilmaz tekrar bakimi yapilamaz,guncellemesi cok zor hatta imkansiz bir hal alir

        uzmanlar reusable mointainable,rahat manipule edilebilir bir framework icin bir design pattern olarak
        ...
        Aradigimiz bir web elementi yada bir methodu kolaylikla bulabilmek ve guncelleyebilmek icin
        javadan ogrenmis oldugumuz oop concept selenium ile page object model de birlestirilmis oluyor.
         */
    }
}
